...
public class Account {
	// ------------------------------------------------------------------------------------------------------
	 ...
	 public final static String namespace = "s3bucket";
	// ------------------------------------------------------------------------------------------------------
...
//	public final static String namespace = "cloud";
	...
	public final static String dafaultUploadPath = "uploadByPost";
//	public final static String dafaultUploadPath = null;//"uploadByPost";
}
